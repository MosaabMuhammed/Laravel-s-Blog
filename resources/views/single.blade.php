                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $post->image_post }}" alt="seo">
                        </div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <div class="socials">
                                ...
                                <a href="#" class="social__item"> <img src="{{ asset('app/svg/circle-facebook.svg') }}" alt="facebook"> </a> <a href="#" class="social__item"> <img src="{{ asset('app/svg/twitter.svg') }}" alt="twitter"> </a> <a href="#" class="social__item"> <img src="{{ asset('app/svg/google.svg') }}" alt="google"> </a> <a href="#" class="social__item"> <img src="{{ asset('app/svg/youtube.svg') }}" alt="youtube"> </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pagination-arrow">
                        @if ($prev)
                            <a href="{{ route('show.post', $prev) }}" class="btn-next-wrap">
                        ...
                        @if ($next)
                            <a href="{{ route('show.post', $next) }}" class="btn-prev-wrap">
                                <svg class="btn-prev">
