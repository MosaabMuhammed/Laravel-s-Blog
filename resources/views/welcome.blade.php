            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset($first_post->image_post) }}" alt="seo">
                        ...
                        <div class="post__content">
                            <div class="post__content-info">
                                    <h2 class="post__title entry-title ">
                                        <a href="/posts/{{ $first_post->slug }}">{{ $first_post->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="/category2/{{ $first_post->category->name }}">{{ $first_post->category->name }}</a>
                                        </span>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset($second_post->image_post) }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ asset($second_post->image_post) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="/posts/{{ $second_post->slug }}">{{ $second_post->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="category2/{{ $second_post->category->name }}">{{ $second_post->category->name }}</a>
                                        </span>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset($third_post->image_post) }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ asset($third_post->image_post) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="/posts/{{ $third_post->slug }}">{{ $third_post->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="/category2/{{ $third_post->category->name }}">{{ $third_post->category->name }}</a>
                                        </span>
        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach ($tutorial->posts()->latest()->take(3)->get() as $post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ asset($post->image_post) }}" alt="our case">
